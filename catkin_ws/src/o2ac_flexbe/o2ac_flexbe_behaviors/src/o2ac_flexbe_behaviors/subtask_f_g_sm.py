...
'''
Created on 1635839183418
@author: AUTOGENERATED
'''
class subtask_f_gSM(Behavior):
	'''
	Behavior extracted from PDDL trace: subtask_f_g
	'''


	def __init__(self):
		super(subtask_f_gSM, self).__init__()
		self.name = 'subtask_f_g'
